    ...
    return (
        <div className="relative h-screen w-screen flex flex-col bg-landing-background overflow-hidden">
            <div className="absolute top-4 left-10">
              <div className="text-3xl font-sans font-extrabold text-fabchat-hoverBackground cursor-pointer">Fabchat</div>
            </div>
            <div className="space-y-4">
                <h1 className="text-center text-[4rem] font-serif font-extrabold mt-[10%] text-white bg-blue-300 bg-opacity-10">
                    IMAGINE A PLACE...
                </h1>
                <div className="w-[60%] text-center text-xl font-serif mx-auto font-bold bg-blue-100 bg-opacity-20 rounded-xl">
